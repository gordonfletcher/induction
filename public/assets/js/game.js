...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    // map tiles
    this.load.image('tiles', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fspritesheet-extruded.png?v=1586002134268');
    // map in json format
    this.load.tilemapTiledJSON('map', '/assets/map/map.json');
    // our two characters
    this.load.spritesheet('player', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2FRPG_assets.png?v=1586002127406', {
      frameWidth: 16,
      frameHeight: 16
    });

    this.load.image('golem', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fcoppergolem.png?v=1586002170312');
    this.load.image('ent', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fdark-ent.png?v=1586002170585');
    this.load.image('demon', '/https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fdemon.png?v=1586002170452');
    this.load.image('worm', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fgiant-worm.png?v=1586002170843');
    this.load.image('wolf', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fwolf.png?v=1586002170989');
    this.load.image('sword', 'https://cdn.glitch.com/4c897f7d-f671-4fee-8921-a6114def7679%2Fattack-icon.png?v=1586002165837');
  }
